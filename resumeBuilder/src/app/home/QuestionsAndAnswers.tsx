...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Resume Builder saves time and prevents formatting mistakes by
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Other than Resume builder, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Resume Builder
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Resume Builder is designed specifically for the I.T job market and
            best practices.
          </span>
          <br />
          ...
          options that are aligned with I.T. best practices. For example, it
        ...
        <p>
          ...
          data in their databases, Resume Builder believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Resume Builder doesn’t require sign up to use the app, and all inputted
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        Divya Chand, Ritu Kandpal & Simran Jyala as
        a Major project. As a student, we had made many mistakes
        ...
        knowledge into this resume builder. Our hope is that Resume Builder can help
